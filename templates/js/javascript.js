...
function botonusuario1(btn) {
  // DESACTIVAR CLASE BOTONES NODO
  $(".btn-tab").removeClass("btn-nav-active");
  $(btn).addClass("btn-nav-active");

  // ACTIVAR TAB DE FUNCIONES
  active_function("#ele-tab-user", "#btn_config");

  $("#tabs-content").html(
    "<div class='cont-convo-fun text-center' id='cont-convo-fun'>fsdfs</div>"
  );
  
  // Cargar("usuariosEdit.php", "cont-convo-fun");
}
function user_eva_edit_2(btn){
...
function botonusuario2(btn) {
  ...
  // ACTIVAR TAB DE FUNCIONES
  active_function("#viab-tab-user", "#btn_config");
  
  $("#tabs-content").html("<div class='nav-functions'>"+
    "<h5 class='tit-nodo'><i class='fa fa-user'></i>&nbsp;Usuario</h5>"+
    "</div>"+
    "<div class='cont-convo-fun text-center' id='cont-convo-fun'>fsdfs</div>");
}
...
function botonusuario3(btn) {
  ...
  // ACTIVAR TAB DE FUNCIONES
  active_function("#jur-tab-user", "#btn_config");
...
function graficasEmpresas(btn) {
  ...
  active_function("#tec-tab-panel", "#tec-btnf-panel");
  
  $("#tabs-content").html(
    "<div class='cont-convo-fun text-center' id='cont-convo-fun'></div>"
  );
...
function graficasEmpresas2(btn) {
  ...
  active_function("#cp-tab-panel", "#cp-btnf-panel");
...
function botonproyecto(btn) {
  active_function("#tec-tab-proy", "#btnpro2");
  $(".btn-tab").removeClass("btn-nav-active");
  $(btn).addClass("btn-nav-active");
  $("#tabs-content").html(
    "<div class='cont-convo-fun text-center' id='cont-convo-fun'></div>"
...
function botoneConflicto(btn) {
  $(".btn-tab").removeClass("btn-nav-active");
  $(btn).addClass("btn-nav-active");
  // ACTIVAR FUNCIONES DE NODO
  active_function("#tec-tab-conf", "#btnConf");
...
function botoneConflictoCp(btn) {
  ...
  // ACTIVAR FUNCIONES DE NODO
  active_function("#cp-tab-conf", "#btnConf");
...
function botoneConflictoUsuEle(btn) {
  ...
  // ACTIVAR FUNCIONES DE NODO
  active_function("#ele-tab-conf", "#btnpro2");
...
function botoneConflictoUsuEleJur(btn) {
  ...
  // ACTIVAR FUNCIONES DE NODO
  active_function("#jur-tab-conf", "#btnpro2");
...
function botoneConflictoUsuVia(btn) {
  ...
  $(btn).addClass("btn-nav-active");
  // ACTIVAR TAB DE FUNCIONES
  active_function("#viab-tab-conf", "#btnpro");
...
function botoneSubsanaciones(btn) {
  ...
  active_function("#tec-tab-sub");

  $("#tabs-content").html(
    "<div class='nav-functions'></div><div class='cont-convo-fun text-center' id='cont-convo-fun'></div>"
  );
  LSubsanaciones($("#btn_sub"));
}
...
function botoneSubsanacionesCp(btn) {
  ...
  $(btn).addClass("btn-nav-active");
  // ACTIVAR TAB DE NODO
  active_function("#cp-tab-sub", "#btn_sub");
...
function botonproyectoaux(btn) {
  ...
  // ACTIVAR TAB DE NODO
  active_function("#aux-tab-proy", "#btnpro2");
...
function botonempresa(btn) {
  ...
  // ACTIVAR BOTONES DE NODO
  active_function("#tec-tab-emp", "#btnemp2");
...
function botonempresa_aux(btn) {
  ...
  // ACTIVAR TAB DE NODO
  active_function("#aux-tab-emp", "#btnemp2");
...
function botonproyectocp(btn) {
  ...
  // ACTIVAR BOTONES DE NODO
  active_function("#cp-tab-proy", "#btnpro");
...
function botonempresacp(btn) {
  ...
  // ACTIVAR BOTONES DE NODO
  active_function("#cp-tab-emp", "#btnemp");
...
function botonevaluacion(btn) {
    ...
    // ACTIVAR TAB DE FUNCIONES
    active_function("#tec-tab-eva", "#eval_pro_ele");
...
function botonevaluacioncp(btn) {
    ...
    // ACTIVAR TAB DE FUNCIONES
    active_function("#cp-tab-eva", "#eval_pro_ele");
  ...
  function botonevaluacionusu1(btn) {
    ...
    // ACTIVAR TAB DE FUNCIONES
    active_function("#ele-tab-eva", "#eval_pro_ele");
  ...
  function botonevaluacionusuJur(btn) {
   ...
   $(".btn-tab").removeClass("btn-nav-active");
    ...
    // ACTIVAR TAB DE FUNCIONES
    active_function("#jur-tab-eva", "#eval_pro_ele");
  ...
  function botonevaluacionusu2(btn) {
    ...
    // ACTIVAR TAB DE FUNCIONES
    active_function("#viab-tab-eva", "#eval_pro_via");
