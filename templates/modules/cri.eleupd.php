<?php //criterios d elegibilidad para actualizar
...
{
echo "CargarDatosCrieleupd($_GET[cod])" ;
}
?>
});
</script>
	...
	<?php 
		...
		<div class="col-md-12">
			<div class="form-group">
				<br>
				<button class="btn-functions" id="btn-upd-cri" onclick="updateCriEle()" ><i class="fas fa-check"></i>&nbsp;Editar</button><button class="btn-functions" id="btn-add-pers" onclick="LCre()"><i class="fas fa-list"></i>&nbsp;Listado</button>
				</div>
		</div>
<?php }
else{?>
