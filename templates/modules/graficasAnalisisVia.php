...
if(isset($_COOKIE['user_code']) && isset($_COOKIE['user_rol']) && ($_COOKIE['user_rol']==5 || $_COOKIE['user_rol']==7 || $_COOKIE['user_rol']==8)){
        ...
        $query=mysqli_query($conect,"SELECT count(*),dia_via FROM `propuestas` where estado>=4 group by dia_via");
        $estado="";
...
<html>
    ...
    <body>
        ...
        <script>
            ...
            var html="<table class='table table-bordered' style='width:100%;'><tr><td bgcolor='#EFE0FC' align='center'><b>Viabilidad</b></td><td bgcolor='#EFE0FC' align='center'><b>N. Proyectos</b></td><td bgcolor='#EFE0FC' align='center'><b>Porcentaje</b></td></tr>";
