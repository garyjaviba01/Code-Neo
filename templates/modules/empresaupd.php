<?php //formulario de empresa para actualizar
...
<script>
    ...
    {
    echo "CargarDatosEmpresaupd($_GET[id])" ;
    }
    ?>
    });
</script>
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" id="nit" maxlength='14' class="form-control inps-forms" onkeypress="return soloNumeros(event)" placeholder="Nit empresa" /><input type="hidden"  id="id" >
        </div>
    </div>
     <div class="col-md-3">
        <div class="form-group">
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>
                Tamaño <span style="color: red;">*</span><i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help4').css('display','block')" onmouseout="$('#help4').css('display','none')"></i>
                <span class="tooltiptext" id="help4" style="display: none;">Según anexo 8</span>
            </label>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <br />
                <button class="btn-functions" id="btn-upd-cri" onclick="updateEmp()"><i class="fas fa-check"></i>&nbsp;Editar</button>
        </div>
    </div>
</div>
<?php }
