...
<div class="panel" id="pan">
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active mr-4">
        ...
        <p style="margin:0 0;color:#0075B0;"><b>Servicio Nacional de Aprendizaje - SENA</b></p>
      </li>
    </ul>
    <span class="navbar-text">
      ...
      <i class="fas fa-question-circle icon_sesion2"  onclick="verhelp('use_sn')" title="Ayuda" ></i>
