<?php  /** 
     Archivo para cargar un proyecto que se va a crear por el gestor técnico o auxiliar técnico   
...
<div id="infogenpro" class="conpes">
 ...
 <div class="col-md-3">
            <div class="form-group" style="text-align: left;">
                ...
                <input type="date" id="fec_rad" class="form-control inps-forms" />
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group" style="text-align: left;">
...
<div id="infofinanciera" class="conpes" style="display: none;">
    ...
    <div style="border-bottom: 1px solid #e0e0e0; background: #fff;">
        <div class="row" id="divinfofin" style="display: block; padding: 15px;">
            ...
            <div>
                <div class="row">
                    <div class="col-md-12" style="color:#0075B0;font-size: 18px;margin: 20px; 0"><b>Datos financieros del proyecto</b> <br /></div>
                    <div class="col-md-3">
                        <div class="form-group">
            ...
            <div>
                <div class="row" id="divanx" style="display: none; padding-left: 15px;">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>
                                Documento <i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help10').css('display','block')" onmouseout="$('#help10').css('display','none')"></i>
                                <span class="tooltiptext" id="help10">Documento o anexo del proyecto</span>
                            </label>
