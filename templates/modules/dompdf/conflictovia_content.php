...
$datos=$obj->DatosConflictoVia($_COOKIE['proyecto'],$_COOKIE['usuario_con'],$_COOKIE['conv']);
...
<br><br><p align="justify">Yo, <?php echo strtoupper($datos[0]); ?> certifico que <?php echo $datos[1]; ?>  tengo conflicto de interés con la empresa con NIT y Razón social : <b><?php echo $datos[2]; ?></b>  para realizar el proceso de evaluación de viabilidad del proyecto : <b><?php echo $datos[3]; ?></b>, postulado para la Convocatoria 
