...
<head>
<meta charset='utf-8'>
<title>Ficha Individual elegibilidad</title>
...
<tr><td colspan="2"><b>TAMAÑO ENTIDAD EJECUTORA (Segun anexo 8)</b>
...
<?php 
$obj->CargarDivevaeleRp($_COOKIE['conv'],$_COOKIE['id_pro']);
$mensaje=$obj->mensaje;
				?>
<table width="100%"  >
<tr><td colspan="5" class="espacio2">
...
<td class="balnco" colspan="1">PROYECTO <?php echo $datos[21]; ?></td>
</tr>	
<tr ><td colspan="4"><?php echo $obj->FormatDate($datos[23]);?></td>
</tr>
<?php $obj->CargarEvaluadoresEleRp($_COOKIE['id_pro']);?>
