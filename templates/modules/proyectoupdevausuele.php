<?php  /** 
     Archivo para cargar un proyecto que se va a vizualizar por el usuario evaluador de elegilibidad,colombia productiva y asesor tecnico   
...
<div class="col-md-3">
            <div class="form-group">
                <label>
                    Fecha radicación SIGP<i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help6_1').css('display','block')" onmouseout="$('#help6_1').css('display','none')"></i>
        ...
        <div class="col-md-12" style="color: #0075b0; text-align: center; font-size: 18px; margin-bottom: 20px;"><br /></div>
        <div class="col-md-12" style="color: #0075b0; font-size: 18px; text-align: center; margin: 20px 0;"><b>Datos financieros del proyecto</b> <br /></div>
        <div class="col-md-3">
            <div class="form-group">
...
<div id="infoplanestras">
    ...
    <div class="display_none" id="divtraP">
        <div class="row" style="padding-left: 15px;">
            <button class="btn lactive" id="link1" onclick="$('#divtraP').addClass('display_none');$('#listadoPT').removeClass('display_none');$('#link1').addClass('lactive');">Volver a listado</button><br />
            <br />
        </div>
