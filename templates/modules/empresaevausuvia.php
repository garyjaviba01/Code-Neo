<?php //fomulario de empresas para evaluador viabilidad
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="form-group">
            <label>
                Razón social<i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help1AS').css('display','block')" onmouseout="$('#help1AS').css('display','none')"></i>
                <span class="tooltiptext" id="help1AS" style="display: none;">Nombre o razón social de la empresa</span>
            </label>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <label>
                Actividad económica<i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help2AS').css('display','block')" onmouseout="$('#help2AS').css('display','none')"></i>
                <span class="tooltiptext" id="help2AS" style="display: none;">Actividad económica de la empresa</span>
            </label>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>
                Nit<i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help3AS').css('display','block')" onmouseout="$('#help3AS').css('display','none')"></i>
                <span class="tooltiptext" id="help3AS" style="display: none;">Nit - incluir dígito de verificación</span>
            </label>
    ...
    <div class="col-md-3">
     ...
     <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="date" id="fec_cons" disabled  class="form-control inps-forms"  />
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>
                Tamaño<i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help4AS').css('display','block')" onmouseout="$('#help4AS').css('display','none')"></i>
                <span class="tooltiptext" id="help4AS" style="display: none;">Según anexo 1</span>
            </label>
     ...
     <div class="col-md-6" >
        <div class="form-group">
            <label>Tipo de Proponente <i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help4ASD').css('display','block')" onmouseout="$('#help4ASD').css('display','none')"></i>
                <span class="tooltiptext" id="help4ASD" style="display: none;">Según anexo 8</span></label>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>
                Dirección<i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help5AS').css('display','block')" onmouseout="$('#help5AS').css('display','none')"></i>
                <span class="tooltiptext" id="help5AS" style="display: none;">Dirección física de la empresa</span>
            </label>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>
                Teléfono<i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help6AS').css('display','block')" onmouseout="$('#help6AS').css('display','none')"></i>
                <span class="tooltiptext" id="help6AS" style="display: none;">Teléfono de la empresa</span>
            </label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label>
                Departamento<i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help7AS').css('display','block')" onmouseout="$('#help7AS').css('display','none')"></i>
                <span class="tooltiptext" id="help7AS" style="display: none;">Departamento de ubicación de la empresa</span>
            </label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label>
                Ciudad<i class="fa fa-question-circle" style="cursor: help; margin-left: 20px;" onmouseover="$('#help8AS').css('display','block')" onmouseout="$('#help8AS').css('display','none')"></i>
                <span class="tooltiptext" id="help8AS" style="display: none;">Ciudad de ubicación de la empresa</span>
            </label>
