<?php //criterios de viabilidad puntaje adicional
if(isset($_COOKIE['user_code']) && isset($_COOKIE['user_rol']) && $_COOKIE['user_rol']==5){?>	<div class="row">
		...
		<div class="col-md-6" style="display:none;">
			...
			<span class="tooltiptext" id="help11" style="display: none;z-index:10000;">Convocatoria a la cual se agregan los criterios </span></label>
...
<option value="1">Valores Agregados</option>
		...
		<div class="col-md-12">
			<div class="form-group">
				<br>
				<button class="btn-functions" id="btn-add-pers" onclick="GuardarCriViapunadc()"><i class="fas fa-check"></i>&nbsp;Guardar</button>
				</div>
		</div>
<?php }
else{?>
