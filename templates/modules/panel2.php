...
<div class="row" id="divpro" style="text-align: left;">
     ...
     else if($totalPro>230 && $totalPro<=280)$img="medidor230-28.png";
     ...
     ?><img src='/templates/assets/<?php echo $img;?>'><br><br><br><h5 style="color: #196b95;">Propuestas registradas : <?php echo $totalPro; ?></h5></div>
     
    <div class="col-md-2" ></div>
    <div class="col-md-2 panel_divs" ><h5 style="color: #196b95;">Análisis regional de propuestas
</h5>
<i class='fa fa-chart-pie icon_sesion' title='Gráfica' onclick="ChartProyectos2()"></i><i class="fa fa-file-excel icon_sesion" title="Descargar excel" onclick="window.open('templates/modules/ExcelProyectos.php')" ></i>
...
<i class='fa fa-chart-pie icon_sesion' title='Gráfica' onclick="ChartAnalisisEle2()"></i><i class="fa fa-file-excel icon_sesion" title="Descargar excel" onclick="window.open('templates/modules/ExcelProyectos.php')" ></i>
...
<i class="fa fa-eye icon_sesion" title="ver" onclick="Act_econoRp2(<?php $obj->TotalAct_eco_emp(); ?>)" ></i>
...
<i class='fa fa-chart-pie icon_sesion' title='Gráfica' onclick="ChartTamanho2()"></i><i class="fa fa-file-excel icon_sesion" title="Descargar excel" onclick="window.open('templates/modules/ExcelEmpresas.php')" ></i>
...
<i class='fa fa-chart-pie icon_sesion' title='Gráfica' onclick="ChartAnalisisVia2()"></i><i class="fa fa-file-excel icon_sesion" title="Descargar excel" onclick="window.open('templates/modules/ExcelProyectos.php')" ></i>
<br><br><b>Viables : </b><?php $obj->TotalViables(); ?><br><b>No viables : </b><?php $obj->TotalNoViables();?><br>
<b>Sin evaluar : </b><?php $obj->TotalNoEvaViables();?><br></div>
