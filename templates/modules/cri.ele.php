...
if(isset($_COOKIE['user_code']) && isset($_COOKIE['user_rol']) && $_COOKIE['user_rol']==5){?>	<div class="row">
	...
	<?php 
		...
		<div class="col-md-12">
			<div class="form-group">
				<br>
				<button class="btn-functions" id="btn-add-pers" onclick="GuardarCriEle()"><i class="fas fa-check"></i>&nbsp;Guardar</button><button class="btn-functions" id="btn-add-pers" onclick="LCre()"><i class="fas fa-list"></i>&nbsp;Listado</button>
				</div>
		</div>
</div>
<?php }
