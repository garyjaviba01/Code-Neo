...
//SELECT count(DISTINCT(propuestas.id)),departamento.nombre FROM propuestas,convocatoria,ciudad,departamento,region WHERE propuestas.id_convocatoria =convocatoria.id and propuestas.ciiudad=ciudad.codigo and ciudad.departamento= departamento.codigo and departamento.region=region.codigo and region.codigo=$_REQUEST[region]  group by departamento.nombre		    
        $query=mysqli_query($conect,"SELECT count(*),propuestas.dia_ele from propuestas,ciudad,departamento,region WHERE propuestas.ciiudad=ciudad.codigo and ciudad.departamento= departamento.codigo and departamento.region=region.codigo and region.codigo=$y group by propuestas.dia_ele");
...
<body>
  ...
  <br />
        ...
        <div id="data" style="width: 100%;">
         <table class='table table-bordered' style='width:100%;'><tr><td bgcolor='#EFE0FC' align='center'><b>Región</b></td><td bgcolor='#EFE0FC' align='center'><b>Sin evaluar</b></td><td bgcolor='#EFE0FC' align='center'><b>Elegibles</b></td><td bgcolor='#EFE0FC' align='center'><b>No elegibles</b></td><td bgcolor='#EFE0FC' align='center'><b>Total región</b></td></tr>  
         <?php 	
         for($i=0;$i<7;$i++){
           ?>  
	...
	<script>
	 var total=<?php echo $total;?>;
		...
		var horizontalBarChartData = {
			labels: ['SIN EVALUAR', 'ELEGIBLES', 'NO ELEGIBLES'],
			datasets: [{
				label: 'AMAZONAS',
