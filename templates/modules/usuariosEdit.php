<?php //formulario para editar datos del usuario
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label>Rol</label>
            <select id="sel-rol" class="custom-select inps-forms mb-3" readonly>
                <option value="3">Evaluador elegibilidad</option>
            </select>
        </div>
        <div class="form-group">
            <label>Estado De Usuario</label>
            <select id="sel-esta" class="custom-select inps-forms mb-3" readonly>
...
<div class="text-center">
    <button class="btn-functions" id="btn-add-pers" onclick="upd_userrr()"><i class="fas fa-check"></i>&nbsp;Actualizar</button>
</div>
<script>
